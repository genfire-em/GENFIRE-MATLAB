...
if ComputeFourierShellCorrelation
    ...
    save(['tmp/projections_half_1' '_start' num2str(start) '.mat'],'pj1')
    save(['tmp/projections_half_2' '_start' num2str(start) '.mat'],'pj2')
    ...
    GENFIRE_parameters_half1.filename_Projections = ['tmp/projections_half_1' '_start' num2str(start) '.mat'];
    GENFIRE_parameters_half2.filename_Projections = ['tmp/projections_half_2' '_start' num2str(start) '.mat'];
    ...
    GENFIRE_parameters_half1.filename_Results = ['tmp/results_half_1.mat' '_start' num2str(start) '.mat'];
    GENFIRE_parameters_half2.filename_Results = ['tmp/results_half_2.mat' '_start' num2str(start) '.mat'];
