...
switch griddingMethod
    ...
    case 3
        ...
        interpTime = toc
        [null1 null2,constraintConfidenceWeights,weightedDistances] = fillInFourierGrid_tomo_C(projections,angles,interpolationCutoffDistance,confidenceWeightVector);%interpolate projections to Fourier grid
